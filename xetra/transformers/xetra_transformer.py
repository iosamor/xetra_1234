...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :param meta_key: used as self.metat_key -> key of meta file
        :param src_keys: NamedTuple class with source configuration data
        :param trg_keys: NamedTuple class with target configuration data
        """
